...
function M.get(c, opts)
  ...
  local ret = {
    ...
    SnacksProfilerIconTrace   = { bg = Util.blend_bg(c.aqua, 0.3), fg = c.dark1 },
    SnacksProfilerBadgeTrace  = { bg = Util.blend_bg(c.aqua, 0.1), fg = c.dark1 },
