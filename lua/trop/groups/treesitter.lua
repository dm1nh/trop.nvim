...
function M.get(c, opts)
  ...
  local ret = {
    ...
    ["@markup.list"]                = { fg = c.aqua }, -- For special punctutation that does not fall in the categories before.
    ...
    ["@punctuation.delimiter"]      = { fg = c.syntax.annotation }, -- For delimiters ie: `.`
    ["@punctuation.special"]        = { fg = c.syntax.special1 }, -- For special symbols (e.g. `{}` in string interpolation)
    ...
    ["@string.regexp"]              = { fg = c.syntax.special1 }, -- For regexes.
    ["@tag"]                        = "Label",
    ...
    ["@type"]                       = "Type",
    ["@type.builtin"]               = { fg = Util.blend_bg(c.accent, 0.8) },
    ...
    ["@variable.member"]            = { fg = c.syntax.field }, -- For fields.
