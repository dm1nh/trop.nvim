...
function M.get(c, opts)
  return {
    ...
    NormalNC = {
      fg = c.fg,
      bg = opts.transparent and c.none or opts.dim_inactive and Util.darken("#000000", 0.1) or c.bg,
    ...
    PmenuMatch = { bg = c.bg_popup, fg = c.fg }, -- Popup menu: Matched text in normal item.
    PmenuSel = { bg = Util.blend_bg(c.fg_gutter, 0.8) }, -- Popup menu: selected item.
    PmenuMatchSel = { bg = Util.blend_bg(c.fg_gutter, 0.8), fg = c.accent }, -- Popup menu: Matched text in selected item.
    ...
    Function = { fg = c.syntax.func, style = opts.styles.functions }, -- function name (also: methods for classes)
    Identifier = { fg = c.syntax.macro, style = opts.styles.variables }, -- (preferred) any variable name
    ...
    PreProc = { fg = c.syntax.macro }, -- (preferred) generic Preprocessor
    Special = { fg = c.syntax.special1 }, -- (preferred) any special symbol
    Statement = { fg = c.syntax.statement }, -- (preferred) any statement
